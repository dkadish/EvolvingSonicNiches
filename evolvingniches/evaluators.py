...
from evolvingniches.messaging import Message, MessageType
from evolvingniches.noise import Noise
...
class DecoderEvaluator(BaseEvaluator):
    ...
    def evaluator(self, genomes, config):
        ...
        while message.type != MessageType.FINISHED:
            ...
            for genome_id, genome in genomes:
                ...
                df_row = self._make_dataframe_row(enc_species_id, enc_genome_id, genome_id, original_message,
                                                  encoded_message,
    ...
    def _make_dataframe_row(self, species, sender, receiver, original, encoded, received, score_identity, score_bit,
                            score_total):
