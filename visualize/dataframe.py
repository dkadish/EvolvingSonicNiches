...
def plot_spectra_and_fitness(spectra: pd.DataFrame, species: pd.DataFrame, cmap='rainbow', view=False, close=True, vmin=None, vmax=None, shape=(5, 5),
                     filename='spectra_fitness.svg', title="Communication Spectra and Fitness for All Runs", base_run=None,
    ...
    fig, axes = plt.subplots(*shape, sharex=True, sharey='row', constrained_layout=True, gridspec_kw={'height_ratios':[1.5,1]}, **kwargs)
...
def plot_species_fitnesses_by_run(fitness: pd.DataFrame, run=None, species=None, role=None, view=False, close=True,
    ...
    sns.lineplot(x="generation", y='fitness', data=fitness.reset_index(), hue='run fitness', estimator=None, alpha=0.25, **kwargs)
